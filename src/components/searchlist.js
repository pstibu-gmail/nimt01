...
const Item = ({
  ...
  return (
    <TouchableOpacity
      ...
      style={[
        styles.treeItem,
        highlighted ? itemHighlightStyle : itemStyle,
        {marginLeft: __depth * indentDistance},
      ]}
...
export default ({
  ...
  const _renderItem = data => <Item data={data} {...itemProps} />;
    ...
    <View style={[style]}>
      <FlatList
        ...
        contentContainerStyle={
          treeData.length > 0 ? {} : {width: '100%', height: '100%'}
        }
        renderItem={_renderItem}
        keyExtractor={item =>
          item.hasOwnProperty(INDEX_PATH) ? item[INDEX_PATH] : item
        }
